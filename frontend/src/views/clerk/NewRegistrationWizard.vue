      ...
      <form @submit.prevent="handleNextStep" class="space-y-6">
        ...
        <div v-if="currentStep === 4" class="bg-white rounded-xl shadow-md p-8 space-y-6">
          ...
          <p class="text-sm text-gray-600">
            ...
            <span v-if="formData.taxExempt" class="block mt-1 text-amber-700">This property is marked as tax-exempt — you may also upload an Exemption Document below (optional).</span>
          </p>
          <DocumentUploadTable v-model="documents" :application-id="editingId || undefined" :tax-exempt="formData.taxExempt" />
        </div>
