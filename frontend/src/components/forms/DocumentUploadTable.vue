      ...
      <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-gray-200 bg-white">
          <tr
            ...
            v-show="doc.type !== 'Exemption Document' || showExemptionRow"
            :key="doc.type"
            class="transition"
          ...
          >
            <td class="px-4 py-3">
              ...
              >*</span>
              <span
                v-else-if="doc.type === 'Exemption Document'"
                class="ml-2 inline-block px-1.5 py-0.5 rounded text-xs font-medium bg-amber-100 text-amber-700"
              >Optional</span>
            </td>
...
// Show the Exemption Document row only when the property is tax-exempt
const showExemptionRow = computed(() => props.taxExempt)
