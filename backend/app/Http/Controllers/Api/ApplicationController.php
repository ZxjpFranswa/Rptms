...
class ApplicationController extends Controller
{
    ...
    public function activate(Request $request, Application $application): JsonResponse
    {
        $this->authorize('review', Application::class);

        $application = $this->workflow->activate($application, $request->user());
        $application->load($this->applications->eagerRelations());
