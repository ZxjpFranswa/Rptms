...
class SampleApplicationsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $samples = [
            ...
            ['intake_ref' => 'INT-2024-002', 'taxpayer_name' => 'Maria Santos', 'property_type' => 'Commercial', 'barangay' => 'San Isidro', 'submission_date' => '2024-01-10', 'status' => ApplicationStatus::Approved, 'last_assessor_action' => 'Approved', 'remarks' => 'All documents complete', 'verification_status' => 'Verified'],
            ...
            ['intake_ref' => 'INT-2024-008', 'taxpayer_name' => 'Miguel Fernandez', 'property_type' => 'Commercial', 'barangay' => 'San Isidro', 'submission_date' => '2024-01-24', 'status' => ApplicationStatus::UnderVerification, 'last_assessor_action' => 'Submitted for Verification', 'verification_status' => 'In Progress'],
        ];
